	...
	<div class="formula">
		<div class="first-row flex items-center justify-center gap-1">
			<span class="part1">
				<Katex
					displayMode
					math={`(Emb_{1,1}Ã—W_{1,1} + \\cdots + Emb_{1,768}Ã—W_{768,1})`}
				/>
			</span>
			<span class="part2">
		...
		<div class="total">
			<Katex
				displayMode
				math={`\\sum_{d=1}^{768} Emb_{id} \\cdot Weights_{dj} + Bias_j = Compressed_Emb{ij}`}
			/>
		</div>
	</div>
</WeightPopoverCard>
